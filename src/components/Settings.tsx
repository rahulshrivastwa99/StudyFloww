...
import { Settings as SettingsIcon, Moon, Sun, Palette, Bell, Download, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* About Section */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">About StudyFlow</h2>
          <div className="space-y-4 text-gray-600 dark:text-gray-400">
            <p>
              StudyFlow is designed to help you build consistent study habits while minimizing distractions. 
              Track your progress, organize your materials, and stay motivated on your learning journey.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <h3 className="font-medium text-gray-900 dark:text-white mb-2">Tips for Success</h3>
                <ul className="text-sm space-y-1">
